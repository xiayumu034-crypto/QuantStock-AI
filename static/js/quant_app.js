...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const init = () => {
        ...
        // 3. 榜单与雷达数据 (之前漏掉的就在这里)
        console.log("Loading rankings and watchlist...");
        if (typeof updateRankings === 'function') updateRankings();
        if (typeof fetchWatchlist === 'function') fetchWatchlist();
        if (typeof loadMLSignals === 'function') loadMLSignals();
