...
def main():
    ...
    with open('model_output/lgb_model_v19.pkl', 'rb') as f:
        model = pickle.load(f)
    
    with open('model_output/features_v19.json', 'r') as f:
    ...
    label = {"Label": "Ref($close, -3) / $close - 1"}
    ...
    df['Predict'] = preds # Probabilities
    ...
    print(f"--- V19 近期测试集评估 (2026-03-01 至今) ---")
